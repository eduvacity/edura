              ...
              return (
                ...
                >
                  <div className="w-full flex justify-between gap-1">
                    <p className="font-normal font-sans text-sm text-pcolor tracking-[0.5px]">
                      {" "}
                      {v.category}
                    </p>
                    <button className="flex gap-[10px] font-bold text-sm font-sans text-pcolor cursor-pointer">
                      Apply <ArrowUp />
                    </button>
                  </div>
                  <h4 className="text-xl/[29px] font-bold font-sans text-[#4D6C62] tracking-[0.5px]">
                    {v.role}
                  </h4>
                  <div className="w-full flex gap-[10px]">
                    <p className="text-base font-medium font-sans text-[#4B4B4B] tracking-[0.5px] flex  gap-2 items-center">
                      <Locationicon /> {v.type}
                    </p>
                    <p className="text-base font-medium font-sans text-[#4B4B4B] tracking-[0.5px] flex  gap-2 items-center">
