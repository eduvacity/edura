      ...
      <div className="w-full flex flex-col xl:flex-row gap-12 max-w-[1575px] mx-auto px-4 xl:pl-10 2xl:pl-12 xl:pr-8 pt-[80px] md:pt-[80px] lg-md:pt-[110px] xl:py-[70px] 3xl:pt-[160px] z-50">
        <div className="flex flex-col gap-12 xl:w-[470px] 2xl:w-[695px]">
          <div className="flex flex-col justify-start items-start gap-4 ">
            <h1 className="font-avant-garde font-bold text-[38px]/[50px] md:text-[48px]/[62px] lg:text-[40px]/[50px] xl:text-[52px]/[68px] 3xl:text-[80px]/[90px] tracking-[0.5px] text-left text-pcolor px-4 md:px-0">
              Learn <span className="text-white">today,</span>
              <span className="block">
                Lead <span className="text-white">tomorrow.</span>
              </span>
            </h1>
            <p className="max-w-[480px] 3xl:max-w-[600px] px-4 md:px-0 font-normal font-avant-garde text-sm/[24px] lg:md:text-[15px]/[24px] xl:text-base 3xl:text-[22px]/[30px] text-left text-white/70 tracking-[0.5px]">
          ...
          <div className="w-full flex flex-col sm:flex-row justify-start items-start gap-[9.77px] xl:gap-6 z-[100]">
            <Link
              href="/programs"
              className="w-full lg:w-fit h-[58px] font-medium font-avant-garde text-[10px]/[100%] xl:text-lg/[21.6px] text-white flex justify-center items-center gap-2 bg-pcolor border border-solid border-pcolor rounded-xl hover:scale-[0.99] cursor-pointer lg-md:px-4"
            >
            ...
            <Link
              ...
              target="_blank"
              className="w-full lg:w-fit h-[58px] font-medium font-avant-garde text-[10px]/[100%] xl:text-lg/[21.6px] text-white flex justify-center items-center gap-2 border-2 border-solid border-pcolor rounded-xl hover:scale-[0.99] cursor-pointer lg-md:px-4"
            >
