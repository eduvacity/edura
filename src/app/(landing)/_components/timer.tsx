  ...
  return (
    ...
    >
      <div className="w-full flex flex-col lg:flex-row justify-start lg-md:justify-center items-center gap-1 lg-md:gap-6">
        <p className="text-xs lg:text-base xl:text-lg text-[#000000] font-semibold font-sans tracking-[0.5px] text-left pl-10 lg:pl-6 xl:pl-0">
        ...
        <div className="flex items-center gap-4 lg:gap-6">
          <div className="w-[47px] h-[45px] rounded-[3px] flex flex-col items-center justify-center border border-[#ACACAC] bg-white">
            <h4 className="text-lg/[20px] text-[#4D6C62] font-semibold font-sans tracking-[0.5px]">
              {formatTime(timeLeft?.days)}
            </h4>
            <span className="font-medium font-sansMd text-xs text-[#4D6C62] uppercase tracking-[0.5px]">
              Days
            </span>
          </div>
          <div className="w-[47px] h-[45px] rounded-[3px] flex flex-col items-center justify-center border border-[#ACACAC] bg-white">
          ...
          <Link
            ...
            className="w-[80px] lg:w-[160px] mt-4 lg:mt-0 text-xs lg:text-base/[41px] h-[45px] font-sans font-semibold underline underline-offset-4 text-[#011B23] tracking-[0.5px] hover:scale-[0.99]"
          >
            Apply Now
          </Link>
        </div>
