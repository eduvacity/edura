          ...
          <div className="w-full flex flex-col lg:flex-row gap-24 justify-center items-center">
            <div className="max-w-[776px] flex flex-col gap-6 ">
              ...
              <Link
                ...
                className="w-[170px] h-[58px] font-medium font-sans text-base xl:text-lg/[21.6px] text-white flex justify-center items-center gap-2 bg-pcolor hover:bg-pcolor/90 border border-solid border-pcolor rounded-xl hover:scale-[0.99] cursor-pointer"
              >
                Get started
              </Link>
            </div>
