      ...
      <div className="w-full flex flex-col gap-4 max-w-[1280px] z-50 bg-white px-12 py-14">
        ...
        <p className="text-justify font-arial font-normal text-base text-[#101828] flex flex-col gap-4">
          ...
          <span>
            ...
            changes to the Terms will indicate your acknowledgement of such
            changes and agreement to be bound by the amended Terms.
          </span>
          <span>
            Please read these Terms carefully before accepting to be bound by
            the Terms.
          </span>
        </p>
        <div className="w-full flex flex-col gap-8">
          <div className="w-full flex flex-col gap-4">
            ...
            <div className=" text-justify font-arial font-normal text-base text-[#101828] flex flex-col gap-4">
              ...
              <span>
                ...
                in the Use of Our Platform and services such as your name, email
                address, physical address, password, billing and payment
                information. This includes non-personal information like the
                domain name of your internet service provider, your geographical
                location, operating system and other relevant statistics.
              </span>
              <span>&quot;Privacy Policy&quot;</span>
              <span>
                means our privacy policy available on the Site, which sets out
                the manner in which personal data We collect from You, or You
                provide to Us, will be used and processed by Us.
              </span>
              <span>&quot;Site&quot;</span>
              <span>
            ...
            <p className=" text-justify font-arial font-normal text-base text-[#101828] flex flex-col gap-4">
              All headings in these Terms are for convenience only and shall not
          ...
          <div className="w-full flex flex-col gap-4">
            ...
            <p className=" text-justify font-arial font-normal text-base text-[#101828] flex flex-col gap-4">
              3.1. In order to access Our Platform, it is necessary for an
              account to be set up by you on the Site. In furtherance of this,
              You will be required to provide Us with certain information about
              yourself when setting up this Account. By providing Us with these
              information, You represent and warrant that You have the authority
              to legally use Our Platform and grant Us all permissions and
              licenses to perform Our obligations as provided in these Terms.
            </p>
            <p className=" text-justify font-arial font-normal text-base text-[#101828] flex flex-col gap-4">
            ...
            <p className=" text-justify font-arial font-normal text-base text-[#101828] flex flex-col gap-4">
              ...
              information at all times during the application process. Failure
              to do so constitutes a breach of these Terms, which may result in
              immediate termination of your Account on our Platform and access
              to the Course contents.
            </p>
            <p className=" text-justify font-arial font-normal text-base text-[#101828] flex flex-col gap-4">
              3.4. You are responsible for safeguarding the password that you
              use to access the Platform and for any activities or actions under
              your password.
            </p>
            <p className=" text-justify font-arial font-normal text-base text-[#101828] flex flex-col gap-4">
              3.5. You agree not to disclose your password to any third party.
              You must notify us immediately upon becoming aware of any breach
              of security or unauthorized use of your Learner Account.
            </p>
          </div>
          <div className="w-full flex flex-col gap-4">
            <h2 className=" text-justify text-2xl font-semibold font-avant-garde text-[#101828] tracking-[0.5px]">
            ...
            <h6 className="text-justify text-lg font-normal font-avant-garde text-[#101828] px-2 italic">
              ...
              available to You, such electronic Notifications shall have the
              same effect as paper Notifications whether or not You chose to
              view the Notifications, unless You had previously withdrawn Your
          ...
          <div className="w-full flex flex-col gap-4">
            ...
            <p className=" text-justify font-arial font-normal text-base text-[#101828] flex flex-col gap-4">
              6.1. Upon the acceptance of the admission offer, the Learner shall
              pay the prescribed fee on the course as Course Fees to access the
              Course Contents.
            </p>
            <p className=" text-justify font-arial font-normal text-base text-[#101828] flex flex-col gap-4">
          ...
          <div className="w-full flex flex-col gap-4">
            ...
            <div className=" text-justify font-arial font-normal text-base text-[#101828] flex flex-col gap-4">
              ...
              <p className=" text-justify font-arial font-normal text-base text-[#101828] flex flex-col gap-4">
                ...
                to all such uses of your content with no compensation paid to
                you.
              </p>
            </div>
          </div>
          ...
          <div className="w-full flex flex-col gap-4">
            ...
            <p className=" text-justify font-arial font-normal text-base text-[#101828] flex flex-col gap-4">
              14.1. We may terminate or suspend your Account immediately with or
          ...
          <div className="w-full flex flex-col gap-4">
            ...
            <p className=" text-justify font-arial font-normal text-base text-[#101828] flex flex-col gap-4">
              ...
              loss of profits, loss of reputation and all interest penalties and
          ...
          <div className="w-full flex flex-col gap-4">
            ...
            <p className=" text-justify font-arial font-normal text-base text-[#101828] flex flex-col gap-4">
              16.1. Except as expressly provided for under applicable laws, both
          ...
          <div className="w-full flex flex-col gap-4">
            ...
            <p className=" text-justify font-arial font-normal text-base text-[#101828] flex flex-col gap-4">
              Neither Party shall be liable for failure to perform, or for delay
              in performing its obligations hereunder if such failure or delay
              shall be due to acts of God, war, riot, civil commotion, Weather,
              labour disputes, failure of sub-contractors or any other cause
          ...
          <div className="w-full flex flex-col gap-4">
            ...
            <p className=" text-justify font-arial font-normal text-base text-[#101828] flex flex-col gap-4">
              ...
              resulting from Our services or Your inability to Use the Site or
              Our services.
            </p>
          </div>
          <div className="w-full flex flex-col gap-4">
            ...
            <p className=" text-justify font-arial font-normal text-base text-[#101828] flex flex-col gap-4">
              ...
              in any jurisdiction, such invalidity and unenforceability shall
              not affect the validity and enforceability of all remaining
              provisions contained in these Terms.
            </p>
          </div>
          <div className="w-full flex flex-col gap-4">
            <h2 className=" text-justify text-2xl font-semibold font-avant-garde text-[#101828] tracking-[0.5px]">
            ...
            <p className="text-justify font-arial font-normal text-base text-[#101828] flex flex-col gap-4">
              These Terms contains the entire agreement between the Parties with
          ...
          <div className="w-full flex flex-col gap-4">
            ...
            <p className=" text-justify font-arial font-normal text-base text-[#101828] flex flex-col gap-4">
              24.1. These Terms shall be governed by and construed in accordance
              with the Laws of the Federal Republic of Nigeria.
            </p>
            <p className=" text-justify font-arial font-normal text-base text-[#101828] flex flex-col gap-4">
              24.2 Any disputes arising under or in connection with the
              validity, interpretation and performance of these Terms that
              cannot be resolved amicably by the parties through negotiation
              within 30 (thirty) days shall be resolved by Arbitration at the in
              accordance with the Arbitration and Mediation Act, 2023.
            </p>
            <p className=" text-justify font-arial font-normal text-base text-[#101828] flex flex-col gap-4">
              24.3. The Parties shall endeavor in good faith to mutually agree
              on the selection of an arbitrator. If the Parties cannot mutually
              agree on the selection of an arbitrator within ten (10) days of
              the request, they shall apply to the Relevant Court For
              Arbitration to appoint an arbitrator. Arbitration proceedings
              shall be conducted in at a mutually agreed location. The
              arbitrator will be requested to render an award within ninety (90)
              days and to provide, in writing the reasoning for the award. The
              decision of any such arbitrator shall be final and binding on the
              Parties.
            </p>{" "}
            <p className=" text-justify font-arial font-normal text-base text-[#101828] flex flex-col gap-4">
              24.4. Each Party shall bear its cost in connection with the
              Arbitration and the arbitrator&apos;s fees shall be split equally
